...
class PipelineExecutor:
    ...
    def _execute_fork(self, node: "ForkNode", ctx: ExecutionContext) -> ExecutionContext:
        ...
        if (node.config.get("repartition_output_to_original") or
                node.config.get("coalesce_output_to_original")):
    ...
    def _execute_merge(self, node: "MergeNode", ctx: ExecutionContext) -> ExecutionContext:
