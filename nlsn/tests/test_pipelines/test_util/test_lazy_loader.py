...
from nlsn.nebula.base import nlazy, extract_lazy_params
from nlsn.nebula.pipelines.pipeline_loader import extract_lazy_params as extract_lazy_params_text
