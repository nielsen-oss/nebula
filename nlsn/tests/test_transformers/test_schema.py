"""Unit-tests for 'schema' transformers."""
...
class TestChangefieldsnullability:
    """Unit-test for ChangeFieldsNullability transformer."""
    ...
    def test_to_nullable(self, df_input):
    ...
    def test_to_non_nullable(self, df_input):
        """
    ...
    def test_to_non_nullable_error(self, spark, df_input):
        """
